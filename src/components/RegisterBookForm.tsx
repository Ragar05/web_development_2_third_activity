...
export const RegisterBookForm = () => {
    ...
    const { addBook, handleCloseDialog } = useStoreContext();
    ...
    const handleAddBook = async () => {
        ...
        if (form.author === "" && form.publicationDate === "" && form.title === "") {
    ...
    return (
        <CustomDialog>
            ...
            <DialogActions>
                <Button variant="contained" color="error" onClick={handleCancelAddBook} disabled={blockButtons}>Cancelar</Button>
                <Button variant="contained" onClick={handleAddBook} disabled={blockButtons}>Agregar</Button>
            </DialogActions>
        </CustomDialog>
    )
}